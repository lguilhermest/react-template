...
export default class Module {
  ...
  protected delete(endpoint: string, config?: AxiosRequestConfig) {
    return this.request('delete', endpoint, config);
  }

  protected async request(method: 'get' | 'post' | 'put' | 'delete', endpoint: string, data?: {}, config?: AxiosRequestConfig) {
